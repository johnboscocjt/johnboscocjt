...
My journey started on Windows, but necessity forced me into the arms of **Linux**. Now, I run a **Triple-OS Environment** (Ubuntu Mother + Kali & Windows VMs) to ensure I can code, hack, and compatibility-test on my pc. 
...
![FilamentPHP](https://img.shields.io/badge/Filament-FFA900?style=for-the-badge&logo=laravel&logoColor=white)
...
*   **🎵 Music Writing and Dancing:** Composing beats and lyrics when the compiler needs a break.
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/JohnboscoCJT)
